 ...
 * @author DELL User
 */
public class frmRegistroCarro extends javax.swing.JFrame {

    /**
     * Creates new form frmRegistroCarro
     */
    public frmRegistroCarro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Registro de automovil");

        jLabel7.setText("Buscar licencia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmRegistroCarro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmRegistroCarro().setVisible(true);
            }
        });
    }
